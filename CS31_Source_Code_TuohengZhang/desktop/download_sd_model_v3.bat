...
if %ERRORLEVEL% equ 0 (
    echo.
    echo ====================================
    echo Download complete^^! You can now launch CS31-1-Rhinoplasty-Prediction-Studio.exe.
    echo Model saved to:
    echo   %MODEL_DIR%
) else (
    echo.
...
echo   %MODEL_DIR%
echo.
echo Nothing to do. You can launch CS31-1-Rhinoplasty-Prediction-Studio.exe now.
